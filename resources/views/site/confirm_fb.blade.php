...
@section('content')
	<div id="failed-container">
		<div class="alert alert-warning" role="alert">  		
			...
			<p>We've found your facebook id '{{ $user->customer_facebook_id }}' in our database.</p>
			<p>Please login with your mobile by clicking the button below and validate your email.</p>
		</div>
		<br/><br/>
		<center><a href="{{ route('mobile', ['email' => $user->customer_facebook_id]) }}"><button type="button" class="btn btn-success"><< Login With Mobile</button></a></center>
	</div>
@endsection
<style>
