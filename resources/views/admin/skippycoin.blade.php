...
<div class="panel panel-default">
  <div class="panel-heading">    
    <center><h3 class="text-green"><i class="fa fa-certificate"></i> Skippy Coin</h3></center>    
  </div>
  <div class="panel-body">
	...
	<div class="row">
	  <div class="col-sm-12 text-center">
		<div align="center"><img src="{{ asset('images/SKC-240.png') }}" alt="Skippycoin" /></div>
		<div align="center">
			...
			<br/></strong>
			<h3>Digital Assets are emerging worldwide it is clearly the future</h3>
	...
	@else
		<div class="col-sm-12 text-center">
			@if($skippycoin == 'off')
				<font color="#FF0000">
					<h3>AUSTRALIAN COMMUNITY SKIPPYCOIN IS NOT ACTIVE YET</h3>
					<h4>if you are participating in the testing, go ahead and enter your wallet address</h4>
		...
		<div class="row">
		  ...
		  <div class="col-sm-10"> 
			{!! Form::open(['route' => 'save.skippywallet', 'method' => 'POST', 'class' => 'form-horizontal row-fluid']) !!}
			<div class="form-group">
			  <center>
				Enter your valid Skippywallet Address here.
				<div class="input-group"> 
					{{ Form::text('customer_skcwallet', null, ['class' => 'form-control', 'id' => 'search-input', 'placeholder' => 'Accuratley Enter 26 to 34 characters']) }} 
