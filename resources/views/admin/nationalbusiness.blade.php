...
<div class="panel panel-default">
  ...
  <div class="panel-body"> @if($level == "Local Resident" or $level == "Community Leader" or $level == "Local Business") 
...
$(function() {
    ...
    <a name="top"></a>
    <h2 align="center"><strong>National Business Membership</strong></h2>
    <br/>
    National Business level unlocks all features such as weblinks and allows you to publish near unlimited quota of Smart Ads and Business Events into the Commercial Directories and post Commercial Articles such as Press Releases into the Commercial Article Categories through all 1000+ Australian town and city websites of the ARN.<br >
    <br>
    ...
    <br>
    <p> This subscription is suitable for a larger Australian business with a complex service delivery geography or any business who wants to promote a product or service state wide or country wide.<br>
      <br>
      <strong>What is the Per Ad Cost?</strong><br>
      Advertising through just one Australia wide Broadcast Smart Ad is effectivley less than $1 per website per year though you have x 1000. Zoom Zoom!<br>
      <br>
      <font color="#cc0000"><strong>BROADCAST PUBLISHING:</strong></font> <br>
      Is the special feature of this level. National Business account allows you to publish through the network in parallel by posting to the STATE group or selecting the Entire&nbsp;Country which employs the broadcast "AUSTRALIA" location tag to All 1000+ town and city websites<br>
      This is a privileged publishing level that practically switches everything on and we reserve the right to withdraw membership from those who don't play fair. National Business members are often also involved in leading community organisations and you can publish into the community directories however please do not post Ads of a commercial nature into the community directories unless they contain a non commercial benefit and are relevant. Short term postings of this nature are more acceptable <br>
      <br>
      While posting in parallel to the entire network is a fast method it is more effective to use your superpowers to post individual Smart Ads with unique content for SEO benefit, for example, describing your branch office service geography using local town or region names is a good Ad strategy. Our advertisers finding success with this have tasked an employee to create and manage unique content and maps for each branch office or service region <br>
      <br>
      <strong>Local Ads position higher than Broadcast Ads</strong><br>
      No fear you can also create Local Ads with this level. NB has a Quota of 1000 hard Ads that can be Local or Broadcast enough to cover even MacDonalds Service Geography! Win directory /category page one top position long term depending on your Ad Age i.e. The most early supporter can secure top of page one in your town. We dont make you bid per click against each other for position, this is an Australian family owned service your Advertising dollar stays in country and it works in hand with hundreds of popular foreign owned Social Media and Backchannel web services giving your customers and employees an easy AUSTRALIAN mechanism to share and promote your business<br>
      </br>
    <div id="div1" class="buttons" align="center">
      <h3>Cost?</h3>
      <br>
      $100 per month (Via Paypal Subscription) or<br>
      $1000 per year (Best Value) or<br>
      Manually Invoiced at $300 per quarter or $1000 per year<br>
      <?php if ($skippycoin == 'on'){echo '<br>
      <font color="cc0000">Until future notice.. i.e while the network has ample supply</font><br>
      All National Business Memberships can accumulate emerging Australian <a href="https://skippycoin.com" target="_blank">Skippycoin</a><br>
      Currently at 273.97261 Roo per day or 100 SKC per year<br>';}?>
      <br>
      ...
      <table align="center" border="0">
        <tr>
          <td><div align="center"><a class="button" id="showdiv2">
              <button type="button" class="btn btn-primary btn-sm" >$100 Monthly</button>
              </a><br>
              <br>
            </div></td>
        ...
        <tr>
          <td><div align="center"><a class="button" id="showdiv3">
              <button type="button" class="btn btn-primary btn-sm" >$1000 Annual</button>
              </a><br>
              <br>
            </div></td>
          <td><img src="{{ $img1 }}" width="96" height="24" align="left" /><br>
    ...
    <div id="div2" style="display:none;" align="center">
      ...
      <br>
      <strong>National Business Subscription $100 per month for up to 1000 flexible <a href="http://{{ $homeurl }}/Example-Ads.php" rel="nofollow" target="_blank">Smart Ads</a> + Access to National Business Features such as Broadcasting, All Directories, Business Events, Article Marketing and Sponsorship Marketing
      <?php if ($skippycoin == 'on')
		{
		echo ' + Receive Top Skippycoin';
		}
	?>
      </strong><br>
      ...
      <input type="hidden" name="item_name" value="National Business Membership" />
      <input type="hidden" name="item_number" value="National Business" />
	  ...
	  <input type="hidden" name="a1" value="100" />
      ...
      <div class="application" align="center"> <a href="{{ route('nationalbusiness') }}">
        <button type="button" class="btn btn-primary">Show other National Business Options</button>
        </a> </div>
      Or<br>
      <div class="application" align="center"><a href="{{ route('localbusiness') }}">
        <button type="button" class="btn btn-primary">View Local Business membership</button>
        </a></div>
    </div>
    <div id="div3" style="display:none;" align="center">
      <h2>Annual Subscription</h2>
      <br>
      <strong>National Business Subscription $1000 per year for up to 1000 flexible <a href="http://{{ $homeurl }}/Example-Ads.php" rel="nofollow" target="_blank">Smart Ads</a> + Access to National Business Features such as Broadcasting, All Directories, Business Events, Article Marketing and Sponsorship Marketing
      <?php if ($skippycoin == 'on')
		{
		echo ' + Receive Top Skippycoin';
		}
	?>
      ...
      <br>
      <h4><font color="#003399">This is the Best Value Instant National Business Option</font></h4>
      {!! Form::open(['route' => 'process.pay', 'method' => 'POST']) !!}
      <input type="hidden" name="cmd" value="_xclick-subscriptions" />
      <input type="hidden" name="business" value="<?php echo $paypal_email; ?>" />
      <input type="hidden" name="item_name" value="National Business Membership" />
      ...
      <input type="hidden" name="image_url" value="https://australianregionalnetwork.com/commonimages/logos/Australian-Regional-Network.png">
      <input type="hidden" name="currency_code" value="AUD" />
	  <input type="hidden" name="a1" value="1000" />
      <input type="hidden" name="p1" value="1" />
      ...
      <img alt="" border="0" src="http://www.paypal.com/images/verification_seal.gif"> {!! Form::close() !!} <br>
      <div class="application" align="center"> <a href="{{ route('nationalbusiness') }}">
        <button type="button" class="btn btn-primary">Show other Natioanl Business Options</button>
        </a> </div>
      Or<br>
      <div class="application" align="center"><a href="{{ route('localbusiness') }}">
        <button type="button" class="btn btn-primary">View Local Business membership</button>
    ...
    <div id="div4" style="display:none;">
      ...
      <br>
      <div class="application" align="center"> <a href="{{ route('nationalbusiness') }}">
        <button type="button" class="btn btn-primary">Other National Business Options</button>
        </a> </div>
