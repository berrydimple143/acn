<div class="row">			    	
	<div class="col-sm-8">
		<div class="form-group">
			...
			<div class="col-sm-9">			    	
				<div class="input-group">
                    {{ Form::text('title', null, ['class' => 'form-control input-sm', 'placeholder' => 'Short Name goes here ...', 'required']) }}
		...
		<div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <div class="input-group">
                                        {{ Form::text('description', null, ['class' => 'form-control input-sm', 'placeholder' => 'Long description goes here ...']) }}
                                        <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                </div>
                        </div>
                </div>
		 <div class="form-group">
            {{ Form::label('filename', 'Upload Photo', ['class' => 'col-sm-3 control-label']) }}
            <div class="col-sm-9">
